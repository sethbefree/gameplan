...
.g-th{padding:.5rem .5rem;font-size:.7rem;color:var(--text);text-align:center;border:1px solid var(--border);background:var(--bg3);white-space:nowrap;font-weight:normal;line-height:1.5;min-width:64px}
...
.g-td-time{padding:.3rem .75rem;font-size:.7rem;color:var(--muted);border:1px solid var(--border);background:var(--bg3);text-align:right;white-space:nowrap}
.g-td{width:64px;height:40px;border:1px solid var(--border);cursor:pointer;transition:background .1s}.g-td.mine{background:#00ff8840;border-color:#00ff8830}.g-td.mine:hover{background:#00ff8866}.g-td:not(.mine):not(.past-col):hover{background:#ffffff0a}.g-td.past-col{background:var(--past);cursor:default}.g-td.mine.past-col{background:#00ff8815;cursor:default}
.g-td-heat{width:64px;height:40px;border:1px solid var(--border);transition:background .3s;display:flex;align-items:center;justify-content:center;font-size:.8rem;font-weight:bold}.g-td-heat.past-col{opacity:.35}
